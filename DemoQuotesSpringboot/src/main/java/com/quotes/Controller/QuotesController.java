...
public class QuotesController {
    ...
    @ApiOperation(value = "getAllQuotes", notes = "Gets all Quotes from Map")
    @ApiResponses(value = {
    ...
    private ResponseEntity<Object> getQuoteFrom(@PathVariable String author) throws QuoteException {
    ...
    @ApiOperation(value = "addQuote", notes = "Adds a quote to the Map")
    @ApiResponses(value = {
